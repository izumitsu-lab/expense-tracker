         ...
         */
        const SYNC_META_KEY = 'premium_tracker_syncmeta_v2';
        ...
        function persistSyncMeta() {
            ...
            try {
                ...
                localStorage.setItem(SYNC_META_KEY, JSON.stringify({ uid: currentUid, maps, cursors: syncCursors, lastFull: lastFullSyncAt }));
